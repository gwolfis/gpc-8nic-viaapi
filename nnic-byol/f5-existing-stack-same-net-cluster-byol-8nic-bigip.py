  ...
  metadata = {
              'items': [{
                  ...
                  'value': ('\n'.join(['#!/bin/bash',
                                    ...
                                    'echo "INT3ADDRESS=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/3/ip\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT3MASK=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/3/subnetmask\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT3GATEWAY=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/3/gateway\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT4ADDRESS=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/4/ip\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT4MASK=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/4/subnetmask\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT4GATEWAY=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/4/gateway\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT5ADDRESS=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/5/ip\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT5MASK=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/5/subnetmask\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT5GATEWAY=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/5/gateway\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT6ADDRESS=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/6/ip\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT6MASK=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/6/subnetmask\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT6GATEWAY=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/6/gateway\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT7ADDRESS=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/7/ip\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    'echo "INT7MASK=$(/usr/bin/curl -s -f --retry 20 \'http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/7/subnetmask\' -H \'Metadata-Flavor: Google\')" >> /config/cloud/gce/interface.config',
                                    ...
                                    'INT4NETWORK=$(/bin/ipcalc -n ${INT4ADDRESS} ${INT4MASK} | cut -d= -f2)',
                                    'INT5NETWORK=$(/bin/ipcalc -n ${INT5ADDRESS} ${INT5MASK} | cut -d= -f2)',
                                    'INT6NETWORK=$(/bin/ipcalc -n ${INT6ADDRESS} ${INT6MASK} | cut -d= -f2)',
                                    'INT7NETWORK=$(/bin/ipcalc -n ${INT7ADDRESS} ${INT7MASK} | cut -d= -f2)',
                                    'PROGNAME=$(basename $0)',
                                    'function error_exit {',
                                    ...
                                    '"tmsh create net vlan internal2 interfaces add { 1.3 } mtu 1460"',
                                    '"tmsh create net self self_internal2 address ${INT3ADDRESS}/32 vlan internal2 allow-service add { tcp:80 tcp:443 }"',
                                    '"tmsh create net route int_gw_interface2 network ${INT3GATEWAY}/32 interface internal2"',
                                    '"tmsh create net route int_rt2 network ${INT3NETWORK}/${INT3MASK} gw ${INT3GATEWAY}"',
                                    '"tmsh create net vlan internal3 interfaces add { 1.4 } mtu 1460"',
                                    '"tmsh create net self self_internal3 address ${INT4ADDRESS}/32 vlan internal3 allow-service add { tcp:80 tcp:443 }"',
                                    '"tmsh create net route int_gw_interface3 network ${INT4GATEWAY}/32 interface internal3"',
                                    '"tmsh create net route int_rt3 network ${INT4NETWORK}/${INT4MASK} gw ${INT4GATEWAY}"',
                                    '"tmsh create net vlan internal4 interfaces add { 1.5 } mtu 1460"',
                                    '"tmsh create net self self_internal4 address ${INT5ADDRESS}/32 vlan internal4 allow-service add { tcp:80 tcp:443 }"',
                                    '"tmsh create net route int_gw_interface4 network ${INT5GATEWAY}/32 interface internal4"',
                                    '"tmsh create net route int_rt4 network ${INT5NETWORK}/${INT5MASK} gw ${INT5GATEWAY}"',
                                    '"tmsh create net vlan internal5 interfaces add { 1.6 } mtu 1460"',
                                    '"tmsh create net self self_internal5 address ${INT6ADDRESS}/32 vlan internal5 allow-service add { tcp:80 tcp:443 }"',
                                    '"tmsh create net route int_gw_interface5 network ${INT6GATEWAY}/32 interface internal5"',
                                    '"tmsh create net route int_rt5 network ${INT6NETWORK}/${INT6MASK} gw ${INT6GATEWAY}"',
                                    '"tmsh create net vlan internal6 interfaces add { 1.7 } mtu 1460"',
                                    '"tmsh create net self self_internal6 address ${INT7ADDRESS}/32 vlan internal6 allow-service add { tcp:80 tcp:443 }"',
                                    '"tmsh create net route int_gw_interface6 network ${INT7GATEWAY}/32 interface internal6"',
                                    '"tmsh create net route int_rt6 network ${INT7NETWORK}/${INT7MASK} gw ${INT7GATEWAY}"',
  ...
  instance = {
        ...
        'networkInterfaces': [{
          ...
          },
          {
              'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/global/networks/',
                                  context.properties['network3']]),
              'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/regions/',
                                  context.properties['region'], '/subnetworks/',
                                  context.properties['subnet3']]),
          },
          {
              'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/global/networks/',
                                  context.properties['network4']]),
              'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/regions/',
                                  context.properties['region'], '/subnetworks/',
                                  context.properties['subnet4']]),
          },
          {
              'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/global/networks/',
                                  context.properties['network5']]),
              'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/regions/',
                                  context.properties['region'], '/subnetworks/',
                                  context.properties['subnet5']]),
          },
          {
              'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/global/networks/',
                                  context.properties['network6']]),
              'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/regions/',
                                  context.properties['region'], '/subnetworks/',
                                  context.properties['subnet6']]),
          },
          {
              'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/global/networks/',
                                  context.properties['network7']]),
              'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                  context.env['project'], '/regions/',
                                  context.properties['region'], '/subnetworks/',
                                  context.properties['subnet7']]),
          }],
